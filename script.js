...
let billPrice = document.getElementById('bill-p');
let tipPrice = document.getElementById('tip-p');
...
tipPrice.innerHTML = '$' + totalTip.toFixed(2);
billPrice.innerHTML = '$' + bill.toFixed(2);
totalPrice.innerHTML ='$' + totalBill.toFixed(2);
}
